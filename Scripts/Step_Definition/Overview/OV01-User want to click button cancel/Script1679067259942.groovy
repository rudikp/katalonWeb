...
WebUI.callTestCase(findTestCase('Pages/CheckoutOverview/Verify_Element_Overview_Page'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/CheckoutOverview/Click_buttonCancel'), [:], FailureHandling.STOP_ON_FAILURE)
