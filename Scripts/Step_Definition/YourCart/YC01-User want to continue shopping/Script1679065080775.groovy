...
WebUI.callTestCase(findTestCase('Pages/YourCart/Verify_Element_YourCart_Page'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/YourCart/Click_buttonContinueShopping'), [:], FailureHandling.STOP_ON_FAILURE)
