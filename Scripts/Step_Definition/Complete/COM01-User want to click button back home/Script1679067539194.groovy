...
WebUI.callTestCase(findTestCase('Pages/CheckoutOverview/Click_buttonFinish'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/CheckoutComplete/Verify_Element_Complete_Page'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/CheckoutComplete/Click_buttonBackHome'), [:], FailureHandling.STOP_ON_FAILURE)
