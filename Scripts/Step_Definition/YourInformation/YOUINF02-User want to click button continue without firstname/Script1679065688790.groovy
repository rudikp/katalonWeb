...
WebUI.callTestCase(findTestCase('Pages/CheckoutYourInformation/Input_lastName'), [('lastName') : 'Kurnia'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/CheckoutYourInformation/Input_zipCode'), [('zipCode') : '12345'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/CheckoutYourInformation/click_buttonContinue'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/CheckoutYourInformation/Read_errorMessage'), [('expected') : 'Error: First Name is required'], 
