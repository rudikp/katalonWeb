...
WebUI.callTestCase(findTestCase('Pages/CheckoutYourInformation/Verifiy_Element_YourInformation_Page'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/CheckoutYourInformation/Click_buttonCancel'), [:], FailureHandling.STOP_ON_FAILURE)
